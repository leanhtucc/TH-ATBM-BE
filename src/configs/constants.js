...
// Thêm thời hạn mới cho Access Token và Refresh Token
export const ACCESS_TOKEN_EXPIRE_IN = '1h' // Access token hết hạn sau 1 giờ
export const REFRESH_TOKEN_EXPIRE_IN = '7d' // Refresh token hết hạn sau 7 ngày
